namespace Derivative
{
    ...
    public class Forward
    {
        ...
        public double FstDe3rdO(double x, double h)
        {
            return (2.0 * f(x + 3 * h) - 9.0 * f(x + 2 * h) + 18.0 * f(x + h) - 11.0 * f(x)) / (6.0 * h);
        }
        public double FstDe4thO(double x, double h)
        {
        ...
        public double SndDe3rdO(double x, double h)
        {
            return (11 * f(x + 4 * h) - 56 * f(x + 3 * h) + 114 * f(x + 2 * h) - 104 * f(x + h) + 35 * f(x)) / (12 * h * h);
        }
        public double SndDe4thO(double x, double h)
        {
        ...
        public double TrdDe3rdO(double x, double h)
        {
            return (7 * f(x + 5 * h) - 47 * f(x + 4 * h) + 122 * f(x + 3 * h) - 154 * f(x + 2 * h) + 95 * f(x + h) - 23 * f(x)) / (4 * h * h * h);
        }
        public double TrdDe4thO(double x, double h)
        {
