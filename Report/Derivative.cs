namespace Derivative
{
    ...
    public class Forward
    {
        ...
        // First Derivative
        public double FstDe1stO(double x, double h)
        {
            return (f(x + h) - f(x)) / h;
        }
        public double FstDe2ndO(double x, double h)
        {
            return (-f(x + 2 * h) + 4 * f(x + h) - 3 * f(x)) / (2 * h);
        }
        public double FstDe3rdO(Func<double, double> f, double x, double h)
        {
            return (2.0 * f(x + 3 * h) - 9.0 * f(x + 2 * h) + 18.0 * f(x + h) - 11.0 * f(x)) / (6.0 * h);
        }
        public double FstDe4thO(Func<double, double> f, double x, double h)
        {
            return (-3 * f(x + 4 * h) + 16 * f(x + 3 * h) - 36 * f(x + 2 * h) + 48 * f(x + h) - 25 * f(x)) / (12 * h);
        }

        // Second Derivative
        public double SndDe1stO(double x, double h)
        {
            return (f(x + 2 * h) - 2 * f(x + h) + f(x)) / (h * h);
        }
        public double SndDe2ndO(double x, double h)
        {
            return (-f(x + 3 * h) + 4 * f(x + 2 * h) - 5 * f(x + h) + 2 * f(x)) / (h * h);

        }
        public double SndDe3rdO(Func<double, double> f, double x, double h)
        {
            return (11 * f(x + 4 * h) - 56 * f(x + 3 * h) + 114 * f(x + 2 * h) - 104 * f(x + h) + 35 * f(x)) / (12 * h * h);
        }
        public double SndDe4thO(Func<double, double> f, double x, double h)
        {
            return (-10 * f(x + 5 * h) + 61 * f(x + 4 * h) - 156 * f(x + 3 * h) + 214 * f(x + 2 * h) - 154 * f(x + h) + 45 * f(x)) / (12 * h * h);
        }

        // Third Derivative
        public double TrdDe1stO(double x, double h)
        {
            return (f(x + 3 * h) - 3 * f(x + 2 * h) + 3 * f(x + 1) - f(x)) / (h * h * h);

        }
        public double TrdDe2ndO(double x, double h)
        {
            return (-3 * f(x + 4 * h) + 14 * f(x + 3 * h) - 24 * f(x + 2 * h) + 18 * f(x + h) - 5 * f(x)) / (2 * h * h * h);

        }
        public double TrdDe3rdO(Func<double, double> f, double x, double h)
        {
            return (7 * f(x + 5 * h) - 47 * f(x + 4 * h) + 122 * f(x + 3 * h) - 154 * f(x + 2 * h) + 95 * f(x + h) - 23 * f(x)) / (4 * h * h * h);
        }
        public double TrdDe4thO(Func<double, double> f, double x, double h)
        {
